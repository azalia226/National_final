		...
		<div id="colorlib-instagram" >
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<p class="tags">
						<span><a href="#"><i class="icon-tag"></i> Alimento</a></span>
						<span><a href="#"><i class="icon-tag"></i> Arqueologia</a></span>
						<span><a href="#"><i class="icon-tag"></i> cabras</a></span>
						<span><a href="#"><i class="icon-tag"></i> Blog</a></span>
						<span><a href="#"><i class="icon-tag"></i> Ciencia</a></span>
						<span><a href="#"><i class="icon-tag"></i> Humano</a></span>
						<span><a href="#"><i class="icon-tag"></i> Genetica</a></span>
						<span><a href="#"><i class="icon-tag"></i> Civilizaciones antiguas</a></span>
						<span><a href="#"><i class="icon-tag"></i> Animales</a></span>
						<span><a href="#"><i class="icon-tag"></i> naturaleza</a></span>
						<span><a href="#"><i class="icon-tag"></i> mas</a></span>
